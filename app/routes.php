...
Gem::get('/paste-create', 'Page@paste')->name('page.paste')->middleware('CheckDomain')->middleware('CheckMaintenance');
...
Gem::get('/paste/{alias}/{pass}/download', 'Paste@paste_download')->name('paste.paste_download');
