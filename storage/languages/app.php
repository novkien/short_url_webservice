<?php 
Chia sẻ các liên kết của bạn với mạng của bạn và đo lường dữ liệu để tối ưu hóa hiệu suất của chiến dịch tiếp thị của bạn. Tiếp cận đối tượng phù hợp với nhu cầu của bạn.return [
  'code' => 'vi',
  'region' => 'vi',
  'name' => 'Tieng viet',
  'author' => 'GemPixel',
  ...
  'data' => [
    ...
    'Share your links to your network and measure data to optimize your marketing campaign\'s performance. Reach an audience that fits your needs.' => 'Quản lý thông tin về đường link của bạn, dễ dàng thu thập lượng ',
