...
return [
  ...
  'data' => [
    ...
    'Address' => 'Địa chỉ',
    'City' => 'Thành phố',
    'Forever' => 'Không thời hạn',
    'One time' => 'Một lần sau khi tạo',
    '1 Hour' => 'Một giờ',
    '1 Day' => 'Một ngày',
    '1 Week' => 'Một tuần',
    '1 Month' => 'Một tháng',
    'Life time' => 'Thời hạn trước khi bị xóa',
    ...
    'Tweet' => 'Tweet',
    'Close' => 'Đóng',
    'QR code scan to access your file, accept images and pdf' => 'Scan QR code để tải về file mà bạn cần, nó có thể là một ảnh hoặc một tệp tin PDF',
    ...
    'Share your link' => 'Chia sẻ link của bạn chỉ bằng mã qr',
    'Share your links to your network and measure data to optimize your marketing campaign\'s performance. Reach an audience that fits your needs.' => 'Quản lý thông tin về đường link của bạn, dễ dàng thu thập lượng truy cập liên kết, quản lý và từ đó dễ dàng đưa ra giải pháp cho dịch vụ của bạn.',
    ...
    'Using plain text format' => 'Sử dụng định dạng văn bản thuần',
    ...
    'Bio Pages' => 'Trang Bio',
    'Empty for no password protection' => 'Để trống nếu không muốn dùng mật khẩu bảo vệ',
    ...
    'Button text Color' => 'Màu chữ của nút',
    'Text' => 'Văn bản',
    'Easy to share your contact' => 'Dễ dàng chia sẻ liên hệ của bạn chỉ bằng một khung hình mã qr',
    'Youtube Video' => 'Video Youtube',
    'Fast connect with your wifi access point' => 'Công cụ dễ dàng tạo kết nối đến wifi chỉ cần quét mã sẽ kết nối ngay lập tức mà không cần nhập liệu',
    ...
    'QR Code Name' => 'Tên nhận biết cho QR',
    ...
    'File Upload (Image or PDF)' => 'Tải lên tệp (hình ảnh hoặc PDF)',
    'View File' => 'Xem tập tin',
    'This can be used to upload an image or a PDF. Most common uses are restaurant menu, promotional poster and resume.' => 'Điều này có thể được sử dụng để tải lên một hình ảnh hoặc PDF. Các mục đích sử dụng phổ biến nhất là đơn hàng shopee đi kèm với một mã qr như là thư gửi khách hàng.',
    'File' => 'Tập tin',
    'Acceptable file: jpg, png, gif, pdf. Max 2MB.' => 'Các tệp được chấp nhận: jpg, png, gif, pdf. Tối đa 2 MB.',
    'Static vCard' => 'Mã QR thẻ liên hệ',
    'Crypto' => 'tiền điện tử',
